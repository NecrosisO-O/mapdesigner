...
export function buildSvgDefs(): string[] {
  return [
    ...
    `<pattern id="pattern-marsh" patternUnits="userSpaceOnUse" width="12" height="12"><rect width="12" height="12" fill="#5EA7B6" opacity="0.12"/><circle cx="3" cy="3" r="1.2" fill="#244F48" opacity="0.24"/><ellipse cx="8" cy="8" rx="2" ry="1" fill="#244F48" opacity="0.18"/></pattern>`,
    `<pattern id="pattern-swamp" patternUnits="userSpaceOnUse" width="14" height="14"><rect width="14" height="14" fill="#4D8FA1" opacity="0.11"/><path d="M2 11 C4 8, 7 10, 9 7" stroke="#1F4039" stroke-width="1" fill="none" opacity="0.28"/></pattern>`,
    `<pattern id="pattern-bog" patternUnits="userSpaceOnUse" width="10" height="10"><rect width="10" height="10" fill="#6D8790" opacity="0.12"/><circle cx="2" cy="3" r="1" fill="#3A4137" opacity="0.28"/><circle cx="7" cy="7" r="1.2" fill="#3A4137" opacity="0.28"/></pattern>`,
    `<pattern id="pattern-reedbed" patternUnits="userSpaceOnUse" width="10" height="10"><rect width="10" height="10" fill="#5EA7B6" opacity="0.1"/><path d="M2 10 L2 2 M5 10 L5 1 M8 10 L8 3" stroke="#4F6C3A" stroke-width="1" opacity="0.3"/></pattern>`,
    `<pattern id="pattern-mangrove" patternUnits="userSpaceOnUse" width="14" height="14"><rect width="14" height="14" fill="#4D8FA1" opacity="0.12"/><path d="M7 2 L7 7 M7 7 L4 10 M7 7 L10 10" stroke="#42563D" stroke-width="1" opacity="0.3"/></pattern>`,
    `<pattern id="pattern-freshwater" patternUnits="userSpaceOnUse" width="14" height="14"><rect width="14" height="14" fill="#5BAED2" opacity="0.16"/><path d="M1 6 Q4 4 7 6 T13 6" stroke="#E9FAFF" stroke-width="1" fill="none" opacity="0.48"/></pattern>`,
    `<pattern id="pattern-marine" patternUnits="userSpaceOnUse" width="16" height="16"><rect width="16" height="16" fill="#2F7DAA" opacity="0.14"/><path d="M1 6 Q5 3 9 6 T17 6 M1 11 Q5 8 9 11 T17 11" stroke="#E2F6FF" stroke-width="1.1" fill="none" opacity="0.48"/></pattern>`,
    `<pattern id="pattern-brackish" patternUnits="userSpaceOnUse" width="14" height="14"><rect width="14" height="14" fill="#5AA6AA" opacity="0.18"/><path d="M1 6 Q4 4 7 6 T13 6" stroke="#E2F6FF" stroke-width="1" fill="none" opacity="0.38"/><circle cx="4" cy="10" r="1" fill="#E2F6FF" opacity="0.28"/></pattern>`,
    `<pattern id="pattern-coral" patternUnits="userSpaceOnUse" width="16" height="16"><rect width="16" height="16" fill="#4FAAA2" opacity="0.11"/><circle cx="4" cy="5" r="2.2" fill="none" stroke="#FFE0D1" stroke-width="1" opacity="0.5"/><circle cx="10" cy="10" r="2" fill="none" stroke="#FFE0D1" stroke-width="1" opacity="0.4"/></pattern>`,
    `<pattern id="pattern-seagrass" patternUnits="userSpaceOnUse" width="14" height="14"><rect width="14" height="14" fill="#3F9DA7" opacity="0.12"/><path d="M3 11 C4 8 5 7 6 3 M8 12 C8 9 9 7 11 4" stroke="#DDF1D5" stroke-width="1" fill="none" opacity="0.45"/></pattern>`,
    `<pattern id="pattern-pack-ice" patternUnits="userSpaceOnUse" width="18" height="18"><rect width="18" height="18" fill="#CDEAF7" opacity="0.16"/><path d="M4 6 L8 4 L12 7 L10 11 L5 10 Z" fill="none" stroke="#F5FBFF" stroke-width="1" opacity="0.55"/></pattern>`,
